...
ggplot(data = medicare_2007_2018) +
  ...
  labs(title = "Medicare Usage Growth Rate",
       caption = "Medicare Growth Rate vs. Population Growth Rate in Washington Counties: 2007 - 2018",
       fill = "Percent Increase"
       )
```
Add white boundary, and source, author, hide code, etc.
