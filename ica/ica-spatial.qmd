...
*You can see the shape of the world, but it would be nice to have a simple map overlayed beneath this.*
...
*There's many starbucks in countries in the global north*
...
ggplot(elections_by_counties, aes(map_id = county_fips, fill = median_rent)) +
  geom_map(map = county_map) +
  scale_fill_gradientn(name = "Median Rent", colors = terrain.colors(10)) +
  expand_limits(x = county_map$long, y = county_map$lat) +
  theme_map() +
  theme(legend.position = "right") + 
  coord_equal()
