...
```{r}
# What does this do? It keeps data from Hawaii and Delaware
 elections_small |> 
...
```{r}
# What did this code do? It added a difference section for 2020.
elections_small |>
...
```{r}
# What did this code do? Estimates the amount of republican votes
elections_small |>
...
```{r}
# What did this code do? Says whether the republicans won or lost the county.
elections_small |>
...
elections_small |>
 mutate(dem_support_change = dem_pct_20 - dem_pct_16) |>
 mutate(dem_support_increase = dem_support_change > 0) |>
 head()
```
